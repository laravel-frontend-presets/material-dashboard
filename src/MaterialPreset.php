...
class MaterialPreset extends Preset
{
    ...
    /**
     * Updates webpack.mix.js to handle all asset updates and changes
     *
     * @return void
     */
